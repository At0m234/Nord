	...
	return (
		<section className='offers'>
			...
			<div className='offers__container'>
				...
				<h3 className='offers__text'>After the complete readiness of the design project,you will receive a full  estimate for the repair and construction work, and you will know for sure:</h3>
